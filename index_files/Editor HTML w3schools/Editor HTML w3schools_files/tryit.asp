  ...
  <div class="w3-modal-content">
    <div class="w3-display-container">
      ...
      <div id="driveText" class="w3-panel w3-large">
        ...
        <input class="w3-input w3-border" type="text" id="googleFileName" value="tryhow_js_fullscreen2">
...
<span onclick="openMenu()" class="w3-button w3-display-topright w3-transparent w3-hover-dark-grey" title="Close Menu" style="font-weight:bold;padding-top:10px;padding-bottom:11px;">&times;</span>
  ...
  <a style="display:inline;padding:0;" href="/about/about_copyright.asp" target="_blank" onclick="openMenu();" class="w3-hover-none w3-hover-text-green">Copyright 1999-2020</a></p>
  </footer>
</div>
